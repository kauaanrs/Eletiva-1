    ...
    <div class="container py-3">
        ...
        <form method="post">
            ...
            <div class="mb-3">
                ...
                <input type="number" step="any" id="desc" name="desc" class="form-control" required="">
            </div>
        ...
        <?php
            if($_SERVER["REQUEST_METHOD"] == "POST"){
                $valor = $_POST["valor"];
                $desc = $_POST["desc"];
                $precoDesc = $valor - $valor * ($desc / 100);
                echo "Valor após desconto de ".$desc."% é igual a: R$".number_format($precoDesc,2,",","."); //Formata casas decimais 
            }
